...
class DifferentialEvolution:
    def __init__(self, func, ub, lb, mutation_prob=0.5, pop_size=50, max_generations=100, type='rand/1/bin'):
        self.fobj = func
        self.lb = lb
        self.ub = ub
        ...
        self.base, self.d, self.rec = type.split('/')
    ...
    def evaluate_population_cost(self, population):
        ...
        self.cost_evals = self.cost_evals + pop_cost.shape[0]
        self.population_cost = pop_cost
        return pop_cost
    ...
    def run(self, debug=True):
        ...
        for generation in range(self.max_generations):
            ...
            survivors = self.select_survivors(u)
